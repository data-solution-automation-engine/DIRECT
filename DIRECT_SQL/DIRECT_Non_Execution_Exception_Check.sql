...
FROM EDW_900_OMD_Framework.dbo.OMD_MODULE_INSTANCE main
JOIN EDW_900_OMD_Framework.dbo.OMD_MODULE module ON main.MODULE_ID=module.MODULE_ID
JOIN
	(
		SELECT MODULE_ID, MAX(MODULE_INSTANCE_ID) as MAX_MODULE_INSTANCE_ID
		FROM EDW_900_OMD_Framework.dbo.OMD_MODULE_INSTANCE
		WHERE MODULE_ID>0
		GROUP BY MODULE_ID
	) maxsub
