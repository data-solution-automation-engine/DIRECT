...
public class ContainerManagerExampleTests
{
  ...
  public async Task Container_Should_Be_Running_And_Accessible()
  {
    ...
    // Assert
    Assert.AreEqual("Hello from SQL Server", result);
  }
  ...
  public async Task Database_Should_Be_Deployed_Successfully()
  {
    ...
    // Assert
    Assert.IsTrue(schemaCount > 0, "DACPAC should have deployed our custom schemas");
  }
  ...
  public async Task GetBatch_StoredProcedure_Should_Exist()
  {
    ...
    // Assert
    Assert.IsTrue(procExists, "omd.GetBatch stored procedure should exist after DACPAC deployment");
  }
}
