...
EXEC [Testing_Framework].[ut].[RegisterTest]
  ...
  ,@Name = 'test-016-attempting-to-run-a-disabled-module-stand-alone'
  ,@TestObject = 'DIRECT'
  /* Test procedure */
	,@Debug = 'Y'
  ,@TestCode = '/*
* test-16-attempting-to-run-a-disabled-module-stand-alone
* Expected outcomes:
* - Framework prevents running a disabled module
...
EXEC [Testing_Framework].[ut].[RunTest]
   @TestName = 'test-016-attempting-to-run-a-disabled-module-stand-alone'
  ,@PlanId = NULL
  ,@Debug = 'Y';
