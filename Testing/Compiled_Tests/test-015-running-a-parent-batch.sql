...
EXEC [Testing_Framework].[ut].[RegisterTest]
  ...
  ,@Name = 'test-015-running-a-parent-batch'
  ,@TestObject = 'DIRECT'
  /* Test procedure */
	,@Debug = 'Y'
  ,@TestCode = '/*
* test-15-running-a-parent-batch
* Expected outcomes:
* - Batch hierarchy runs parents and children as expected
...
EXEC [Testing_Framework].[ut].[RunTest]
   @TestName = 'test-015-running-a-parent-batch'
  ,@PlanId = NULL
  ,@Debug = 'Y';
