...
EXEC [Testing_Framework].[ut].[RegisterTest]
  ...
  ,@Name = 'test-013-batch-run-with-two-modules-module-of-which-one-failed-cancelling-1st-and-reloading-2nd'
  ,@TestObject = 'DIRECT'
  /* Test procedure */
	,@Debug = 'Y'
  ,@TestCode = '/*
* test-13-batch-run-with-two-modules-module-of-which-one-failed-cancelling-1st-and-reloading-2nd
* Expected outcomes:
* - Batch and Module performs as expected recovering after partial failure
...
EXEC [Testing_Framework].[ut].[RunTest]
   @TestName = 'test-013-batch-run-with-two-modules-module-of-which-one-failed-cancelling-1st-and-reloading-2nd'
  ,@PlanId = NULL
  ,@Debug = 'Y';
