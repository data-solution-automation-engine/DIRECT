...
EXEC [Testing_Framework].[ut].[RegisterTest]
  ...
  ,@Name = 'test-9-failure-test-failing-3-times-in-a-row-and-then-recover-using-rollback'
  ,@TestObject = 'DIRECT'
  /* Test procedure */
	,@Debug = 'Y'
  ,@TestCode = '/*
...
EXEC [Testing_Framework].[ut].[RunTest]
   @TestName = 'test-9-failure-test-failing-3-times-in-a-row-and-then-recover-using-rollback'
  ,@PlanId = NULL
  ,@Debug = 'Y';
