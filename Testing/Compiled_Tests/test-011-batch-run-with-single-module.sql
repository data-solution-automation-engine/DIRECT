...
EXEC [Testing_Framework].[ut].[RegisterTest]
  ...
  ,@Name = 'test-011-batch-run-with-single-module'
  ,@TestObject = 'DIRECT'
  /* Test procedure */
	,@Debug = 'Y'
  ,@TestCode = '/*
* test-11-batch-run-with-single-module
* Expected outcomes:
* - Module runs successfully in a batch context
...
EXEC [Testing_Framework].[ut].[RunTest]
   @TestName = 'test-011-batch-run-with-single-module'
  ,@PlanId = NULL
  ,@Debug = 'Y';
