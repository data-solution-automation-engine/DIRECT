...
******************************************************************************/
    ...
    -- Exception handling: The Batch Id cannot be NULL or 0
    IF @BatchId IS NULL OR @BatchId = 0
    BEGIN
      SET @LogMessage = N'A Valid Batch Id was not found for Batch Code ''' + @BatchCode + '''';
    ...
    BEGIN TRY
      ...
      SET @BatchInstanceStartTimestamp = @UtcNow;
