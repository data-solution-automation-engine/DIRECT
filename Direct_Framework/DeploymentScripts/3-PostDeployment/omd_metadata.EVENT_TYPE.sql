...
DECLARE @tblMerge TABLE(
  ...
  [EVENT_TYPE_DESCRIPTION]  NVARCHAR (4000) NULL
);

INSERT INTO @tblMerge([EVENT_TYPE_CODE], [EVENT_TYPE_DESCRIPTION])
VALUES
...
WHEN MATCHED THEN
  UPDATE
  SET      [EVENT_TYPE_DESCRIPTION] = src.[EVENT_TYPE_DESCRIPTION]
