...
-- DELETE FROM OMD_MODULE_INSTANCE WHERE MODULE_INSTANCE_ID=139411
-- DELETE FROM OMD_BATCH_INSTANCE WHERE BATCH_INSTANCE_ID=58732
...
FROM OMD_BATCH_INSTANCE main
JOIN OMD_BATCH batch ON main.BATCH_ID=batch.BATCH_ID
JOIN
    (
...
SELECT
    ...
    main.END_DATETIME,
    main.EXECUTION_STATUS_CODE
FROM OMD_MODULE_INSTANCE main
JOIN OMD_MODULE module ON main.MODULE_ID=module.MODULE_ID
JOIN
    (
