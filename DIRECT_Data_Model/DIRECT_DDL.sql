...
(
 ...
 CONSTRAINT [PK_NEXT_RUN_INDICTATOR] PRIMARY KEY CLUSTERED ([NEXT_RUN_INDICATOR] ASC)
);
GO
...
(
 ...
 CONSTRAINT [FK_ERROR_BITMAP_ERROR_TYPE] FOREIGN KEY ([ERROR_TYPE_CODE]) REFERENCES [dbo].[ERROR_TYPE]([ERROR_TYPE_CODE]),
 CONSTRAINT [FK__ERROR_BITMAP_SEVERITY] FOREIGN KEY ([SEVERITY_CODE]) REFERENCES [dbo].[SEVERITY]([SEVERITY_CODE])
);
GO
