CREATE FUNCTION [dbo].[GetLoadWindowDateTimes] ( @module_code VARCHAR(255), @start_or_end tinyint)
...
BEGIN 
       ...
       BEGIN
              ...
              WHERE MODULE_ID = (SELECT MODULE_ID FROM omd.MODULE WHERE omd.MODULE.MODULE_CODE=@module_code)
              ) ranksub
              WHERE ROW_NR=1
       END
